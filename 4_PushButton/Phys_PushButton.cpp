////////////////////////////////////////////////////////
// Filename : Phys_PushButton.cpp
// Author : Sed Centeno
// Date : 11/29/2024
//
// Description :
// Gets the status of the physical pushbutton and publishes
// it to the Adafruit I/O indicator.
//
// Arguments :
// None
//
...
#define TOPIC      "Adasc592/feeds/project.button-pressed"
...
int main(int argc, char* argv[]) {
   ...
   // GPIO Button
   sprintf(str_payload, "%d", Btn.getValue());
